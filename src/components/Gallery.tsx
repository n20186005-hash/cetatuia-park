...
const photos = [
  { src: '/gallery/images (1).jpg', alt: '采图亚公园全景' },
  { src: '/gallery/images (2).jpg', alt: '公园与建筑' },
  { src: '/gallery/images (3).jpg', alt: '城市全景' },
  { src: '/gallery/images (4).jpg', alt: '绿地步道' },
  { src: '/gallery/images (5).jpg', alt: '山顶观景' },
  { src: '/gallery/images (6).jpg', alt: '日落景观' },
  { src: '/gallery/images (7).jpg', alt: '历史遗迹' },
  { src: '/gallery/images (8).jpg', alt: '十字架纪念碑' },
  { src: '/gallery/images (9).jpg', alt: '索梅什河景观' },
  { src: '/gallery/images (10).jpg', alt: '林荫步道' },
  { src: '/gallery/images (11).jpg', alt: '夜景灯火' },
  { src: '/gallery/images (12).jpg', alt: '休闲人群' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-6 gap-4 items-center">
              <a
                href="https://maps.app.goo.gl/9zpt5yb8LEUNdpdq9"
                target="_blank"
